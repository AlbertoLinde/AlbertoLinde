...
<!--  <div style="text-align: center; padding: 20px;">-->
    <h3>WHIRLIPEDE</h3>
    <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/544.png" alt="WHIRLIPEDE" width="200" style="display: block; margin: 0 auto;" />
    <p style="font-size: 14px;">Pokemon Generated: 587</p>
<!--  </div>-->
<!-- POKEMON END -->
    <td style="text-align: center; padding: 20px; width: 50%;">
