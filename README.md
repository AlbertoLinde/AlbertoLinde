...
<!--  <div style="text-align: center; padding: 20px;">-->
    <h3>FERROSEED</h3>
    <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/597.png" alt="FERROSEED" width="200" style="display: block; margin: 0 auto;" />
    <p style="font-size: 14px;">Pokemon Generated: 252</p>
<!--  </div>-->
<!-- POKEMON END -->
    <td style="text-align: center; padding: 20px; width: 50%;">
