...
<!--  <div style="text-align: center; padding: 20px;">-->
    <h3>GRANBULL</h3>
    <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/210.png" alt="GRANBULL" width="200" style="display: block; margin: 0 auto;" />
    <p style="font-size: 14px;">Pokemon Generated: 389</p>
<!--  </div>-->
<!-- POKEMON END -->
    <td style="text-align: center; padding: 20px; width: 50%;">
